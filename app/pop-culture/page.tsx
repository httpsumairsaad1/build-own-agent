...
export default function PopCulturePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col font-sans selection:bg-[#E64A19] selection:text-white">
      ...
      {/* Topic Hero */}
      <section className="border-b border-[#2C2C2C] bg-gradient-to-b from-[#2A102C] to-[#0A0A0A] px-4 lg:px-8 py-8 lg:py-10">
        <div className="max-w-[1280px] mx-auto space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1E1E1E] border border-[#2C2C2C] text-[11px] font-semibold text-[#AB47BC]">
            <span className="w-2 h-2 rounded-full bg-[#AB47BC]" />
            <span>Category Feed</span>
          </div>
          <h1 className="text-3xl lg:text-4xl font-bold tracking-tight text-white">
            Pop Culture, Creators &amp; Digital Media
          </h1>
          <p className="text-sm text-[#9E9E9E] max-w-2xl leading-relaxed">
            Critical analysis of entertainment industry transformations, creator-led media distribution, streaming economics, and contemporary digital cultural phenomena.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 lg:px-8 py-3 border-b border-[#2C2C2C] bg-[#0E0E0E]">
        <div className="max-w-[1280px] mx-auto flex items-center justify-between">
          <span className="text-xs text-[#9E9E9E]">
            Showing <strong className="text-white">{articles.length}</strong> culture perspectives
          </span>
